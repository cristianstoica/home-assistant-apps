...
def test_o15_correction_disclosures_live_at_the_dialog_and_the_verification_page(
    ...
    assert "Current inputs no longer match the basis pinned for this run" in show_html
    assert (" — results reflect that pinned basis, not current data.") in show_html
    assert (
